...
declare module 'nearley/lib/compile' {
  type CompileOptions = {
    alreadyCompiled?: Array<any>;
    version?: any;
    nojs?: boolean;
    args?: Array<any>;
  };
  const compile: <CompileResult = any>(
    grammarAst: any,
...
declare module 'nearley' {
  ...
  export class Parser<ParseResult = any, Feedstock = string> {
    /**
  ...
  export type BuiltinPostprocessorName =
    | 'joiner'
    | 'arrconcat'
    | 'arrpush'
    | 'nuller'
    | 'id';
  export type BuiltinPostprocessor = { builtin: BuiltinPostprocessorName };
  export type Postprocessor = PostprocessorFunction | BuiltinPostprocessor;
